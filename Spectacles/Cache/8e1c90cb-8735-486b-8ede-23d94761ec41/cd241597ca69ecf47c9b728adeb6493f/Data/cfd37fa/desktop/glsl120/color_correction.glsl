...
sc_SoftwareWrapEarly(l9_0,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_1=l9_0;
float l9_2=Globals.gScreenCoord.y;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_3=l9_2;
vec2 l9_4;
float l9_5;
...
{
l9_6=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_6=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_7=l9_1;
float l9_8=1.0;
sc_ClampUV(l9_7,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_6,l9_8);
float l9_9=l9_7;
float l9_10=l9_8;
bool l9_11;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_12=l9_3;
float l9_13=l9_10;
sc_ClampUV(l9_12,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_11,l9_13);
l9_5=l9_13;
...
#endif
vec2 l9_14=sc_TransformUV(l9_4,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_15=l9_14.x;
float l9_16=l9_5;
sc_SoftwareWrapLate(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_16);
float l9_17=l9_14.y;
float l9_18=l9_16;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_18);
float l9_19=l9_18;
vec3 l9_20=sc_SamplingCoordsViewToGlobal(vec2(l9_15,l9_17),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_21=texture2D(opacityTex,l9_20.xy,0.0);
vec4 l9_22;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_22=mix(opacityTexBorderColor,l9_21,vec4(l9_19));
}
#else
{
l9_22=l9_21;
...
ssGlobals l9_5=ssGlobals(l9_1,l9_2,0.0,l9_4);
vec4 l9_6;
#if (USE_LEGACY_512_TEXTURE)
{
float l9_7=l9_4.x;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x);
float l9_8=l9_7;
float l9_9=l9_4.y;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
...
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x==3;
}
#else
{
...
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,screenTextureUvMinMax.x,screenTextureUvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,screenTextureUvMinMax.y,screenTextureUvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x,(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0)),l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y,(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0)),l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),screenTextureLayout,screenTextureGetStereoViewIndex());
vec4 l9_28=texture2D(screenTexture,l9_27.xy,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_29=mix(screenTextureBorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
#endif
float l9_30;
Node11_Conditional(1.0,1.0,Port_Input2_N011,l9_30,l9_5);
float l9_31=(l9_29.z*255.0)/4.0;
vec2 l9_32=clamp(vec2(floor(l9_31))+vec2(0.0,1.0),vec2(0.0),vec2(63.0));
vec2 l9_33=floor((l9_32/vec2(8.0))+vec2(1e-06));
vec4 l9_34=((l9_29.yyxx*0.12304688)+(vec4(l9_33,l9_32-(l9_33*8.0))*0.125))+vec4(0.0009765625);
l9_6=vec4(mix(l9_29.xyz,mix(N12_BaseTexture_sample(vec2(l9_34.z,1.0-l9_34.x)).xyz,N12_BaseTexture_sample(vec2(l9_34.w,1.0-l9_34.y)).xyz,vec3(l9_31-l9_32.x))*baseColor.xyz,vec3(baseColor.w*l9_30)),1.0);
}
#else
{
float l9_35=l9_4.x;
sc_SoftwareWrapEarly(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x);
float l9_36=l9_35;
float l9_37=l9_4.y;
sc_SoftwareWrapEarly(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y);
float l9_38=l9_37;
vec2 l9_39;
float l9_40;
#if (SC_USE_UV_MIN_MAX_screenTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x==3;
}
#else
{
...
float l9_42=l9_36;
float l9_43=1.0;
sc_ClampUV(l9_42,screenTextureUvMinMax.x,screenTextureUvMinMax.z,l9_41,l9_43);
float l9_44=l9_42;
float l9_45=l9_43;
bool l9_46;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y==3;
}
#else
{
l9_46=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_47=l9_38;
float l9_48=l9_45;
sc_ClampUV(l9_47,screenTextureUvMinMax.y,screenTextureUvMinMax.w,l9_46,l9_48);
l9_40=l9_48;
...
#endif
vec2 l9_49=sc_TransformUV(l9_39,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform);
float l9_50=l9_49.x;
float l9_51=l9_40;
sc_SoftwareWrapLate(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x,(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0)),l9_51);
float l9_52=l9_49.y;
float l9_53=l9_51;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y,(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0)),l9_53);
float l9_54=l9_53;
vec3 l9_55=sc_SamplingCoordsViewToGlobal(vec2(l9_50,l9_52),screenTextureLayout,screenTextureGetStereoViewIndex());
vec4 l9_56=texture2D(screenTexture,l9_55.xy,0.0);
vec4 l9_57;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_57=mix(screenTextureBorderColor,l9_56,vec4(l9_54));
}
#else
{
l9_57=l9_56;
...
#endif
float l9_58=l9_57.z*15.0;
vec2 l9_59=clamp(vec2(floor(l9_58))+vec2(0.0,1.0),vec2(0.0),vec2(15.0));
vec3 l9_60=((l9_57.xxy*vec3(0.05859375,0.05859375,0.9375))+vec3(l9_59*0.0625,0.0))+vec3(0.001953125,0.001953125,0.03125);
float l9_61=l9_60.x;
...
float l9_77=l9_76.x;
float l9_78=l9_67;
sc_SoftwareWrapLate(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_78);
float l9_79=l9_76.y;
float l9_80=l9_78;
sc_SoftwareWrapLate(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_80);
float l9_81=l9_80;
...
float l9_101=l9_90;
sc_SoftwareWrapLate(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_101);
float l9_102=l9_99.y;
float l9_103=l9_101;
sc_SoftwareWrapLate(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_103);
float l9_104=l9_103;
...
#endif
float l9_108;
Node11_Conditional(1.0,1.0,Port_Input2_N011,l9_108,l9_5);
l9_6=vec4(mix(l9_57.xyz,vec4(mix(l9_84.xyz,l9_107.xyz,vec3(l9_58-l9_59.x)),0.0).xyz*baseColor.xyz,vec3(baseColor.w*l9_108)),1.0);
}
#endif
...
{
l9_111=clamp(l9_6.w*2.0,0.0,1.0);
}
#else
{
float l9_112;
...
{
l9_112=clamp(dot(l9_6.xyz,vec3(l9_6.w)),0.0,1.0);
}
#else
{
float l9_113;
...
{
l9_114=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*l9_6.w;
}
#else
{
float l9_115;
...
{
l9_115=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*l9_6.w;
}
#else
{
float l9_116;
...
{
l9_116=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_117;
#if (sc_BlendMode_Add)
{
l9_117=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_118;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_118=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_119;
...
{
l9_119=dot(l9_6.xyz,vec3(0.33333001))*l9_6.w;
}
#else
{
float l9_120;
#if (sc_BlendMode_Min)
{
l9_120=1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_121;
...
#endif
l9_109=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_6.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_110);
}
#else
{
vec4 l9_122;
...
#if (sc_FramebufferFetch)
{
vec4 l9_125=sc_readFragData0_Platform();
vec4 l9_126;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_127=l9_125;
l9_127.x=l9_125.x+_sc_framebufferFetchMarker;
l9_126=l9_127;
}
#else
{
...
#else
{
vec2 l9_128=sc_ScreenCoordsGlobalToView(l9_3);
int l9_129;
...
#endif
l9_124=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_128,sc_ScreenTextureLayout,l9_129).xy,0.0);
}
#endif
vec4 l9_130;
...
{
vec4 l9_131=l9_124;
l9_131.x=l9_124.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_130=l9_131;
}
#else
{
...
#endif
vec3 l9_132=mix(l9_130.xyz,definedBlend(l9_130.xyz,l9_6.xyz).xyz,vec3(l9_6.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_134=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_6.w)),l9_6.w);
}
#else
{
vec4 l9_135;
...
#endif
l9_135=vec4(l9_6.xyz*l9_136,l9_136);
}
#else
{
l9_135=l9_6;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_143-0.0039215689)),min(1.0,l9_143+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_144=sc_ScreenCoordsGlobalToView(l9_3);
...
#endif
int l9_145=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_144).xy);
float l9_146=packValue(l9_145);
int l9_153=int(l9_142.w*255.0);
float l9_154=packValue(l9_153);
sc_writeFragData0(vec4(packValue(l9_145),packValue(l9_145),packValue(l9_145),packValue(l9_145)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_157=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_162==0)
{
l9_165=texture2D(sc_OITAlpha0,l9_157);
l9_164=texture2D(sc_OITDepthLow0,l9_157);
l9_163=texture2D(sc_OITDepthHigh0,l9_157);
}
else
{
l9_165=vec4(0.0);
...
if (l9_162==1)
{
l9_168=texture2D(sc_OITAlpha1,l9_157);
l9_167=texture2D(sc_OITDepthLow1,l9_157);
l9_166=texture2D(sc_OITDepthHigh1,l9_157);
}
else
{
l9_168=l9_165;
...
vec4 l9_183=texture2D(sc_OITFilteredDepthBoundsTexture,l9_157);
